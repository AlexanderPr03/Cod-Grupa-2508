...
function getProductPrice(index) {
    // datele de iesire (ceea ce functia va intoarce)
    return produse[index].price;
}

// apelul functiei, ceea ce intoarce functia atribuim unei variabile
let pret_laptop = getProductPrice(0);
console.log(pret_laptop)
